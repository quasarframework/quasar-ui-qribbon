...
export default {
  ...
  data () {
    return {
      title: 'QRibbon',
      tagline: 'Embeddable Ribbons for your Quasar App',
      byline: 'Created and maintained by Allan Gaunt',
      bylineTwitter: 'https://twitter.com/originalwebnoob',
      quasarDesc: 'A Quasar Framework Component and App Extension',
      locationUrl: 'https://github.com/quasarframework/quasar-ui-qribbon',
      donateUrl: 'https://github.com/sponsors/webnoob'
    }
  }
}
</script>
